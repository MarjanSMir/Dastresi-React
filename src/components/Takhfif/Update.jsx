...
const EditProduct = () => {
  ...
  const handleEdit = async (e) => {
    ...
    try {
      // یافتن محصول فعلی از داده‌های سرور
      ...
      // ترکیب داده‌های جدید با داده‌های فعلی
    ...
    <div className="w-full h-auto  bg-slate-400">
      ...
      >
        ...
        <div className="m-1 flex flex-col items-start">
          <label htmlFor="name" className="m-3 text-white">
            نام محصول
            <input
              className="rounded p-3 m-3 text-black"
              type="text"
        ...
        <div className="m-4 flex flex-col items-start">
          <label htmlFor="model" className="m-3 text-white">
            مدل
            <input
              className="rounded p-3 m-3 text-black"
              type="text"
